...
def push_bark(msg: str, key: str = None):
    if key:
        requests.post(
            f"https://api.day.app/str",
            json={
                "body": msg,
                "title": "imoutai 预约通知",
                "badge": 1,
                "category": "imaotai",
                "sound": "minuet.caf",
                "icon": "https://is1-ssl.mzstatic.com/image/thumb/Purple221/v4/f0/ef/dc/f0efdc0a-55b2-2bf5-b6c2-47fa4af446ca/AppIcon-0-0-1x_U007emarketing-0-7-0-0-sRGB-85-220.png/460x0w.webp",
                "group": "imaotai",
            },
        )
...
def getResult(mobile: str, token: str, bark: str):
    """
    领取耐力
    """
    ...
    if res.status_code == 200:
        for item in res.json().get("data", {}).get("reservationItemVOS", []):
